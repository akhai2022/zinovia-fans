...
export const FEATURES: Record<string, FeatureData> = {
  subscriptions: {
    ...
    benefits: [
      ...
      { title: "Automatic Billing", description: "Stripe handles all billing, renewals, and failed payment recovery. You focus on creating, we handle the payments." },
      { title: "48-Hour Payouts", description: "Your earnings arrive within 48 hours via Stripe Connect. No waiting weeks or months to access your money." },
    ],
    details: [
      ...
      { title: "Global Payments", description: "Accept payments from fans worldwide through Stripe. Support for all major cards and payment methods." },
    ],
    faqs: [
      ...
      { q: "What payment methods do subscribers use?", a: "Stripe processes all payments and supports all major credit and debit cards, Apple Pay, Google Pay, and other local payment methods depending on the subscriber's country." },
      { q: "How quickly do I get paid?", a: "Zinovia processes payouts through Stripe Connect. Your earnings are transferred to your bank account within 48 hours of clearing." },
      ...
      { q: "What happens if a payment fails?", a: "Stripe automatically retries failed payments over several days. If the payment ultimately fails, the subscription is cancelled and the fan loses access to exclusive content." },
    ],
  },
  payouts: {
    slug: "payouts",
    ...
    description: "Get paid within 48 hours on Zinovia. Stripe Connect powers instant creator payouts to your bank account. No minimum thresholds, no monthly delays.",
    heroHeading: "Get paid fast.",
    heroAccent: "48 hours.",
    heroDescription: "No waiting weeks for your earnings. Zinovia pays creators within 48 hours via Stripe Connect — directly to your bank account.",
    benefits: [
      ...
      { title: "Stripe Connect Powered", description: "Industry-leading payment infrastructure handles your payouts. Secure, reliable, and globally available." },
    ...
    details: [
      ...
      { title: "Global Bank Support", description: "Stripe Connect supports bank accounts in 40+ countries. Get paid in your local currency." },
      ...
      { title: "Tax Documentation", description: "Stripe provides tax forms and documentation to help you stay compliant with your local tax requirements." },
    ],
    faqs: [
      { q: "How fast are payouts on Zinovia?", a: "Payouts are processed within 48 hours via Stripe Connect. The exact timing depends on your bank's processing speed, but most creators receive funds within 2 business days." },
      ...
      { q: "Which countries are supported?", a: "Stripe Connect supports payouts to bank accounts in 40+ countries. Check Stripe's documentation for the full list of supported countries." },
      { q: "What currency will I receive?", a: "You receive payouts in your local currency. Stripe handles currency conversion automatically at competitive exchange rates." },
